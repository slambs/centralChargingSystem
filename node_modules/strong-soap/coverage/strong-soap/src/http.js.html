...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/http.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">strong-soap/src</a> http.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  buildRequest(rurl, data, exheaders, exoptions) {
    ...
    var path = [curl.pathname || <span class="branch-1 cbranch-no" title="branch not covered" >'/',</span> curl.search || '', curl.hash || ''].join('');
...
&nbsp;
  ...
  isNtlmAuthRequired(ntlmSecurity, methodName) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (ntlmSecurity == null) {
      return false;
    } else <span class="cstat-no" title="statement not covered" >if (methodName === 'GET' &amp;&amp; (ntlmSecurity.wsdlAuthRequired == null || ntlmSecurity.wsdlAuthRequired === false)) {</span>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!ntlmAuth) {
...
<span class="cstat-no" title="statement not covered" >        options.url = rurl;</span>
<span class="cstat-no" title="statement not covered" >        options.username = ntlmSecurity.username;</span>
<span class="cstat-no" title="statement not covered" >        options.password = ntlmSecurity.password;</span>
<span class="cstat-no" title="statement not covered" >        options.domain = ntlmSecurity.domain;</span>
<span class="cstat-no" title="statement not covered" >        options.workstation = ntlmSecurity.workstation;</span>
        //httpntlm code uses lower case for method names - 'get', 'post' etc
        var method = <span class="cstat-no" title="statement not covered" >options.method.toLocaleLowerCase();</span>
<span class="cstat-no" title="statement not covered" >        debugSensitive('NTLM options: %j for method: %s', options, method);</span>
<span class="cstat-no" title="statement not covered" >        debug('httpntlm method: %s', method);</span>
<span class="cstat-no" title="statement not covered" >        req = httpntlm['method'](method, options, <span class="fstat-no" title="function not covered" >fu</span>nction (err, res) {</span>
<span class="cstat-no" title="statement not covered" >          if (err) {</span>
<span class="cstat-no" title="statement not covered" >            return callback(err);</span>
          }
          var body = <span class="cstat-no" title="statement not covered" >self.handleResponse(req, res, res.body);</span>
