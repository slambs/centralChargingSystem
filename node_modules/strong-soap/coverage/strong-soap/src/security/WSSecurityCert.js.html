...
&nbsp;
function <span class="fstat-no" title="function not covered" >insertStr(</span>src, dst, pos) {
...
class WSSecurityCert extends Security {
  constructor(privatePEM, publicP12PEM, password, encoding) {
    super();
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!ursa) {
<span class="cstat-no" title="statement not covered" >      throw new Error(g.f('Module {{ursa}} must be installed to use {{WSSecurityCert}}'));</span>
    }
