...
<html lang="en">
<head>
    <title>Code coverage report for strong-soap/src/parser/wsdl/definitions.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../../index.html">All files</a> / <a href="index.html">strong-soap/src/parser/wsdl</a> definitions.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  addChild(child) {
    ...
    else <span class="missing-if-branch" title="if path not taken" >I</span>if (child instanceof Documentation) {
    }
  }
}
&nbsp;
